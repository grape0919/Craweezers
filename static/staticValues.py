...
clickedButtonStyleSheet = "color: white;"
clickedButtonStyleSheet += "background-color: #1978DC;"
clickedButtonStyleSheet += "border-style: solid;"
clickedButtonStyleSheet += "border-width: 2px;"
clickedButtonStyleSheet += "border-color: #2F92FA;"
clickedButtonStyleSheet += "border-radius: 5px"
